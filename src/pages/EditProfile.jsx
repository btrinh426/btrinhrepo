...
class EditProfile extends React.Component {
  ...
  componentDidMount = () => {
    ...
    let personId = this.props.match.params.inputId;
  ...
  componentDidUpdate(preProps) {
    let inpId = this.props.match.params.inputId;
    console.log("EditProfile componentDidUpdate:");
    if (inpId && preProps.match.params.inputId !== inpId) {
  ...
  onUpdateClick = (e) => {
    ...
    let id = this.props.match.params.inputId;
    //   {
    //     "title": "string",
    //     "bio": "string",
    //     "summary": "string",
  ...
  onEditFriendByIdError = (res) => {
    console.warn("onEditFriendByIdError:", res);
  };
