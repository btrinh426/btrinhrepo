...
const friendService = {
    ...
    search: "https://localhost:50001/api/friends/paginate?pageIndex=", // FIX THIS AS NECCESSARY
};
...
const searchFriends = (index, size, query) => {
    console.log(`Searching For ${query}`);
    const config = {
        method: "GET",
        url: `${friendService.getAll}${index}&pageSize=${size}&q=${query}`,
        crossdomain: true,
        headers: { "Content-Type": "application/json" },
    };
