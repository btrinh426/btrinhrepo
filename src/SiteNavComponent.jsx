      ...
      <nav className="navbar navbar-expand-md navbar-dark bg-primary sabio">
        ...
        <div className="collapse navbar-collapse" id="navbarsExampleDefault">
          <ul className="navbar-nav mr-auto">
            ...
            <li className="nav-item">
              <NavLink to="/friends">
                <button className="nav-link disabled">Friends</button>
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink to="/blogs">
                <button className="nav-link disabled">Blogs</button>
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink to="/techcompanies">
                <button className="nav-link disabled">Tech Companies</button>
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink to="/jobs">
            ...
            <li className="nav-item">
              <NavLink to="/login">
                <button className="nav-link disabled">Login</button>
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink to="/logout">
