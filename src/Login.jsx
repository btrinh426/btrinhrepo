        ...
        return (
            <React.Fragment>
                <div className="container pt-5 pb-5">
                    <ToastContainer />
                    <form className="card">
                        <div className="card-header text-center bg-dark text-white text-large"><h3>WELCOME</h3></div>
                        ...
                        <div className="form-group row mx-auto pb-3">
                            <button className="btn btn-light"><NavLink to="/register">Register Now</NavLink></button>
                        </div>
                    </form>
                </div>
            </React.Fragment>
