...
class NavBar extends React.Component {
    onAddWidget = () => {
        this.props.history.push("/addwidget")
    };
                ...
                <div className="collapse navbar-collapse" id="navbarsExampleDefault">
                    <ul className="navbar-nav mr-auto">
                        ...
                        <li className="nav-item">
                            <button className="nav-link link-button" onClick={this.onWidgets}>Widgets</button>
                        </li>
                        <li className="nav-item">
                            <button className="nav-link link-button" onClick={this.onAddWidget}>Add Widget</button>
                        </li>
                        <li className="nav-item">
                            <button className="nav-link link-button" onClick={this.onCars}>Cars</button>
                        </li>
