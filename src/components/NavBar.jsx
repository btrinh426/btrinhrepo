...
class NavBar extends React.Component {
  ...
  onCurrUserSuccess = (response) => {
    let curId = response.data.item.id;
    this.inStateChange(curId);
  };
  ...
  onClickCurrentUser = () => {
    if (this.state.isLogIn || this.props.currentUser.isLoggedIn) {
      UserService.currentUser()
  ...
  render() {
    ...
    let DataToLoad = appState
      ? this.props.currentUser.UsersInfo
      : navState
