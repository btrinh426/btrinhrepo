...
import { getJobs, jobSearch, jobDelete } from "../services/jobs";
...
class Jobs extends Component {
  ...
  onDeleteJob = (jobId) => {
    jobDelete(jobId).then(this.onJobDeleteSuccess).catch(this.onJobDeleteError);
  };

  onJobDeleteSuccess = (jobDeleted) => {
    this.setState((prevState) => {
  ...
  onJobDeleteError = (response) => console.error(response);
