  ...
  render() {
    return (
      <React.Fragment>
        ...
        value={this.state.friend.title} onChange={this.onFormFieldChanged} />
        ...
        value={this.state.friend.bio} onChange={this.onFormFieldChanged} />
        ...
        value={this.state.friend.summary} onChange={this.onFormFieldChanged} />
        ...
        value={this.state.friend.headline} onChange={this.onFormFieldChanged} />
        ...
        value={this.state.friend.slug} onChange={this.onFormFieldChanged} />
        ...
        <div className="col-sm-10" />
        <input type="text" className="form-control" name="statusId"
        value={this.state.friend.statusId} onChange={this.onFormFieldChanged} />
        ...
        <div className="col-sm-10" />
        <input type="text" className="form-control" name="primaryImage"
        value={this.state.friend.primaryImage} onChange={this.onFormFieldChanged} />

        <button type="submit" className="btn btn-primary submit" onClick={this.handleClick}>
          Submit
        </button>
      </React.Fragment>
    );
