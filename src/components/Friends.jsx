...
class Friends extends Component {
  ...
  clickShowHideFriends = (e) => {
    ...
    if (e.currentTarget.innerText.indexOf("Show") !== -1) {
      ...
      document.getElementById("friendAddUpdateFormBorder").classList.add("d-none");
    } else {
  ...
  clickFriendCardEditButton = (e) => {
    ...
    document.getElementById("friendAddUpdateFormBorder").classList.remove("d-none");
    document.getElementById("displayFriendCards").classList.add("d-none");
    document.getElementById("getFriends").innerText = "Show Active Friends";
    this.updateFriendForm(friendId);
  };

  updateFriendForm = (friendId) => {
    let stateFriends = [...this.state.friends];
    let friendInfo = stateFriends.find((friend) => friend.id === friendId);

    this.setState((prevState) => {
      const newState = { ...prevState };
      newState.newFriend = friendInfo;
      return newState;
    });
    ...
    document
      .getElementById("friendImageDisplay")
      .setAttribute("src", friendInfo.primaryImage ? friendInfo.primaryImage.imageUrl : this.defaultFriendImage);
  };
  ...
  addUpdateFriendForm = () => {
    return (
      <div
        className="d-none container row border border-secondary rounded mb-0 mr-3 ml-0 p-3"
        ...
        <div className="col pl-3 pt-0 pb-0 m-0">
          <div className="row">
            ...
            >
              ...
              <div className="row mr-1 pt-3 ml-0" style={{ justifyContent: "center", borderTop: "2px #8e9194 solid" }}>
                <Button
                  type="submit"
                  color="success"
                  className="m-1"
      ...
      <div className="col pl-3 mr-3">
        ...
        >
          <div className="col pl-3 pt-0 pb-0 m-0">
            ...
            <div>{this.addUpdateFriendForm()}</div>
            <div className="row">
