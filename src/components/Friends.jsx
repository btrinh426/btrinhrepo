...
class Friends extends React.Component {
  ...
  onDeleteFriendSuccess = () => {
    const renderNew = this.state.currentUser;
    console.log("onDeleteFriendSuccess:", renderNew);
    window.location.reload();    // need to set state on this to have it render   how?
    // var updater = (prevState, props) => {
    //   var newUser = {...this.state.currentUser}
    //   newUser.changeTed = "theodore2";
