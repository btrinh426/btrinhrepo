...
class Friends extends Component {
  ...
  mapSingleFriend = (aFriend) => {
    ...
    return (
      <div
        className={aFriend.statusId !== "Active" ? " cardparent notInDatabase" : "cardParent"} // This class just 'tags' the card for future use
  ...
  updateFriendsView = () => {
    ...
    // clicks on the "Show Active Friends" button.
