                ...
                <div style={{marginTop: '80px'}}>
                    {
                        ...
                        Misc.historyToArray(this.props)[0] === "jobs" ? <JobsMainContent pushHistory={this.props.pushHistory} getHistory={this.props.getHistory} setAppState={this.props.setAppState} getAppState={this.props.getAppState}></JobsMainContent> :
                        null
                    }
                </div>
            </React.Fragment>
