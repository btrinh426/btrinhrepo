...
class FriendFormik extends React.Component {
  ...
  onSave = (formValues) => {
    ...
    if (this.state.formData.id) {
      console.log(
        `Detected an Id of: ${this.state.formData.id} - ${this.state.formData.name}s record will now be updated.`
      );
            ...
            <Form>
              ...
              <div>
                ...
                <FastField
                  ...
                  className="form-control"
                />
                {formikProps.touched.breed && formikProps.errors.breed && (
                  <div className="text-danger">{formikProps.errors.breed}</div>
                )}
              </div>
              <div>
                ...
                {formikProps.touched.weight && formikProps.errors.weight && (
                  <div className="text-danger">{formikProps.errors.weight}</div>
                )}
              </div>
              <div>
