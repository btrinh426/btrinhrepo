...
class EventAddModal extends Component {
    ...
    if (this.props.modalShown && this.props.modalShown !== this.state.showModal) {
      ...
      if (
        ...
        newState.eventForm = {
          ...
          dateStart: modalEvent.dateStart,
          dateEnd: modalEvent.dateEnd,
  ...
  clickSubmitButton = (e) => {
    ...
    const eventData = { ...this.state.eventForm };
    eventData.statusId = eventData.statusId ? "Active" : "NotSet";
    this.props.submitEventForm(eventData);
  };

  clickEventClearButton = (e) => {
    // This function is called when the EventForm "Clear" button is clicked
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              ...
                              <Button type="reset" color="warning" className="m-2" onClick={this.clickEventClearButton}>
                                Clear Form
                              </Button>
