...
import * as dogService from "../../../services/entityService";
import { Formik, FastField, Form } from "formik";
import * as Yup from "yup"; // for everything
import debug from "sabio-debug";

const _logger = debug.extend("ProviderDetailsFormBasic");
...
class DogForm extends React.Component {
  ...
  propsToFormData(props) {
    ...
    //console.log(item);
    _logger("pulling in props to form data", item);
    return item;
  }
    ...
    if (this.state.formData.id) {
      dogService
        ...
        .then((data) => {
          ...
          _logger("dogService update", data);
        })
  ...
  onCancel = (event) => {
    this.props.onCancel();
    _logger("onCancel", event);
  };

  onDelete = (event) => {
    _logger("onDelete", event);
    dogService
      .getSpecificRecord(this.state.formData.id)
