...
const validationSchema = Yup.object().shape({
  ...
  headline: Yup.string()
    ...
    .max(255, "Headline needs to be between 2 and 80 characters in length.")
    .required("Required"),
  slug: Yup.string()
    .min(2, "Slug needs to be between 2 and 100 characters in length.")
    .max(255, "Slug needs to be between 2 and 100 characters in length.")
    .required("Required"),
...
class FriendForm extends Component {
  ...
  onFriendsFormChange = (e) => {
    // This function updates state when a form input is changed
  ...
  clickFriendClearButton = (e) => {
    // This function is called when the FriendForm "Clear" button is clicked
    this.setState(() => {
      const newState = { ...this.state };
      ...
      newState.friendForm.primaryImageUrl = ""; //this.defaultFriendImage;
      return newState;
    });
  };
