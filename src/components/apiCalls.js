...
// apiHandler.addFriend = (friend) => {
//     const config = {
//         method: "POST",
//         url: `${apiHandler.userEndpoint}friends`,
//         data: friend,
//         crossdomain: true,
//         headers: { "Content-Type": "application/json" }
//     };
...
// apiHandler.getFriends = (idx, pageSize) => {
//     const config = {
//         method: "POST",
//         url: `${apiHandler.userEndpoint}friends?pageIndex=${idx}&pageSize=${pageSize}`,
//         crossdomain: true,
//         headers: { "Content-Type": "application/json" }
//     };
