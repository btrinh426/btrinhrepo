    ...
    return (
      <React.Fragment>
        ...
        <main role="main" className="pt-5 mt-2">
          ...
          <Route path="/friends/new" component={FriendForm}></Route>
          <Route path="/friends/:id/edit" component={FriendForm}></Route>
          <Route path="/productform" exact component={ProductForm}></Route>
          <Route path="/fileupload" exact component={FileUpload}></Route>
          <Route path="/jobform/new" component={JobForm}></Route>
          <Route path="/jobform/:id/edit" component={JobForm}></Route>
