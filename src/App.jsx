...
import SecondAssessment from "./component/SecondAssessment";
import AddUpdateFriendsV2 from "./component/AddUpdateFriendsV2";
      ...
      <React.Fragment>
        ...
        <Switch>
          ...
          <Route
            ...
            component={AddUpdateFriendsV2}
          ></Route>
          <Route path="/form" component={AddUpdateFriendsV2}></Route>
          <Route path="/addfriend" component={AddUpdateFriendsV2}></Route>
          <Route path="/events" exact={true} component={Events}></Route>
          <Route path="/assessment" component={SecondAssessment}></Route>
        </Switch>
        <Footer />
      </React.Fragment>
    );
