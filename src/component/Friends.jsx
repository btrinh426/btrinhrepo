  ...
  onRemoveSuccess = (id) => {
    ...
    if (id) {
      this.setState((prevState) => {
        ...
        let newFriednsState = { ...prevState.friends };
        if (deletedFriendIndex > 0) {
          newFriednsState.splice(deletedFriendIndex, 1);
        }
        let friendCompoents = newFriednsState.map(this.mapFriends);
        return { friends: newFriednsState, friendCompoents };
      });
    }
  };
