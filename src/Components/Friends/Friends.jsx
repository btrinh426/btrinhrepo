...
class Friends extends React.Component {
    ...
    onEditOk = res => {
        ...
        this.setState(prevState => {
            ...
            newState.display.ShowFriends = true;
            newState.display.AddFriend = false;
            newState.display.ShowNewFriend = false;
            newState.display.EditFriend = false;
            newState.display.editPayload = false;
