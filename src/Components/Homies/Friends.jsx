...
class Friends extends React.Component {
    ...
    clickHandler = e => {
        _logger("Click Detected", e.target);
        ...
        switch (button) {
            ...
            case "Delete Friend":
                ...
                // Use push to re-render remaining friends
                // this.props.history.push(
                //     `/friends/myfriends`
                // );
                friendServices
                    .deleteFriend(e.currentTarget.value)
                    .then(this.onDeleteOk)
                    .then(this.onDeleteFail);

                break;
            case "Friend Search":
                friendServices
                    .searchFriends(0, 3, this.state.query)
                    .then(this.onGetFriendsOk)
                    .then(this.onGetFriendsFail);
                break;
            default:
    ...
    onDeleteOk = res => {
        _logger("Delete Successful with: ", res);
        friendServices
            .pagedFriends(this.state.pageIndex, 3)
            .then(this.onGetFriendsOk)
            .then(this.onGetFriendsFail);
    };
    onDeleteFail = err => {
        _logger("Delete Failed with error: ", err);
    };
            ...
            <div className="container-fluid">
                <div className="greet">
                    <h1 className="greethl">
                        Sup {this.state.currentUser.firstName}
                    </h1>
