...
import { addFrinedSchema } from "../schemas/userSchemas";
...
class FriendForm extends Component {
  ...
  handleSubmit = (values, { resetForm }) => {
    ...
    if (this.state.friendId) {
      // console.log(this.state.friendData.primaryImage.id);

      values.primaryImageId = this.state.friendData.primaryImage.id;
      // console.log(values);
      friendService
        .updateFriendWithId(values, this.state.friendId)
      ...
      friendService
        ...
        .then(() => resetForm(this.state.friendData))
        .then(() => resetForm(this.state.friendId))
    ...
    return (
      <React.Fragment>
        <Formik
          ...
          validationSchema={addFrinedSchema}
            ...
            return (
              <Container>
                <Row>
                  ...
                  <Row>
                    <div className="col-sm-2" style={{ height: "20" }}>
                      <img
                        src={
                  ...
                  <Col sm="12" md={{ size: 6, offset: 3 }}>
                    <Form onSubmit={handleSubmit} className={"col-md-6 pt-4"}>
                      ...
                      <Button type="submit" outline color="primary">
                         {this.state.friendId ? "Update" : "Submit"}
                      </Button>{" "}
                      <Button
