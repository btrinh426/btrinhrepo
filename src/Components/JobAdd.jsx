...
class JobAdd extends React.Component {
    ...
    if (
      ...
      this.setState(() => {
        ...
        newState = {
          ...
          techCompanyId: cardData.techCompany.id,
          skills: cardData.skills.map(this.mapSkills).join(", "),
          jobId: "TrelloJob",
        };
  ...
  onEditByIdError = (err) => {
    console.error(err);
    toast["error"]("You Have No Job with This Id", "Edit Job");
  };
  ...
  // ----- Changing the Form Field and State -----
  ...
  onAddJobError = (err) => {
    ...
    if (err.response.data.errors) {
      toast["error"](`${err.response.data.errors}`, "New Job");
    } else {
      toast["error"](`${err}`, "New Job");
    }
  };
  ...
  onEditIdError = (err) => {
    console.error(err);
    toast["error"](`${err.response.data.errors}`, "Edit Job");
  };
