        ...
        return(
            ...
            <div className="d-flex" id="wrapper">
                ...
                <div className="list-group list-group-flush">
                    ...
                    <a href="#" className="list-group-item list-group-item-action bg-light">Friends</a>
                    <a href="#" className="list-group-item list-group-item-action bg-light">Blogs</a>
                    <a href="#" className="list-group-item list-group-item-action bg-light">Tech Companies</a>
                    ...
                    <a href="#" className="list-group-item list-group-item-action bg-light">Register</a> 
                </div>
