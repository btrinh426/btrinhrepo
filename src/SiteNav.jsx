                ...
                <nav className="navbar navbar-expand-md navbar-dark fixed-top bg-dark sabio">
                    ...
                    <div className="collapse navbar-collapse" id="navbarsExampleDefault">
                        ...
                        <li className="nav-item active">
                            <button className="nav-link link-button"><NavLink className="text-white" to="/homepage">
                            Home</NavLink> <span className="sr-only">(current)</span>
                            </button>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link link-button" to="/friends">People</NavLink>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link link-button" to="/register">Register</NavLink>
                        </li>
                        {/* <li className="nav-item">
