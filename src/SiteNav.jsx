        ...
        <nav className="navbar navbar-expand-md navbar-dark fixed-top bg-dark sabio">
          ...
          <div className="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul className="navbar-nav mr-auto">
              ...
              <li className="nav-item">
                <NavLink to="/people" exact className="nav-link link-button">
                  Add People
                </NavLink>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <NavLink to="/blogs" exact className="nav-link link-button">
                  Blogs
                </NavLink>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <NavLink to="/jobs" exact className="nav-link link-button">
                  Jobs
                </NavLink>
              </li>
              <li className="nav-item">
